...
for i in range(1, 62, 4): #1 62 4
    index_list.append(i)
    print("inter:", i)
    dist_df = gen_dist_df(98, i, noise_percent=1, error_percent=error, verbosity=0)

    old_error, res_points = reconstruct(dist_df, err_ord='edm_rel', ret_points=True, verbosity=0)
    ...
    full_less_error = reconstruct(full_less_df, err_ord='edm_rel', verbosity=0)
    ...
    half_less_error = reconstruct(half_less_df, err_ord='edm_rel', verbosity=0)
    ...
    quarter_less_error = reconstruct(quarter_less_df, err_ord='edm_rel', verbosity=0)
